...
export interface UserPreferencesDocument extends Omit<IUserPreferences, "_id">, Document {}
...
userPreferencesSchema.statics.getOrCreateForUser = async function (userId: string | mongoose.Types.ObjectId) {
...
export default mongoose.model<UserPreferencesDocument>(
  "UserPreferences",
