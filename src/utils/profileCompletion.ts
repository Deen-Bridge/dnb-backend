import {
  ...
  ProfileFieldResult,
  UserProfileInput,
} from "../types/profileCompletion.js";
 ...
 */
export const getCompletionLevel = (percentage: number): ProfileCompletionLevel => {
 ...
 * @param fieldDefinitions Optional custom field definitions
 * @returns Comprehensive profile completion result
 */
export const calculateProfileCompletion = (
  user?: UserProfileInput | null,
  fieldDefinitions: ProfileFieldDefinition[] = DEFAULT_PROFILE_FIELDS
): ProfileCompletionResult => {
  ...
  const fieldResults: ProfileFieldResult[] = [];
  const missingFieldDefs: ProfileFieldDefinition[] = [];
