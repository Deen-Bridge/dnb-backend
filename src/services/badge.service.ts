...
export class BadgeService {
  /**
   * Initializes default system badges if they do not exist.
   */
  ...
  /**
   * Evaluates user milestone achievements and awards badges automatically.
   */
  async checkAndAwardBadges(userId) {
    ...
    // Count category completion totals
